...
public class ChordsFragment extends Fragment implements SongAdapterListener, SwipeRefreshLayout.OnRefreshListener,
        Constants {
...
//    private List<FavoriteContacts> aartiList = new ArrayList<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listChordsData = Application.allChordsData;
    }
...
//        getAllSongsData();
        ...
        adapter = new SongItemAdapter(getActivity(), listChordsData);
...
//            actionMode = startSupportActionMode(actionModeCallback);
    ...
    private void markAllSavedUnsaved(boolean isSaved) {
        ...
        for (int i = 0; i < selectedItemPositions.size(); i++) {
            ...
            listChordsData.get(position).setIsFavorites(isSaved);
//            adapter.removeData(selectedItemPositions.get(i));

            updateFavoritesInDB(listChordsData.get(position));
        }
        adapter.notifyDataSetChanged();
    }
...
//        List<Integer> selectedItemPositions = adapter.getSelectedItems();
//        for (SongObject article : listChordsData) {
...
//        toggleSelection(position);
    ...
    public void onIconImportantClicked(int position) {
        ...
        listChordsData.set(position, songObject);
        adapter.notifyDataSetChanged();
...
//        Application.songObject = listChordsData.get(position);
//
