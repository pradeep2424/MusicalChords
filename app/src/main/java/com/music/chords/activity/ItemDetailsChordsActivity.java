...
//        }, 500);
    ...
    private void initYouTubeViewPlayer() {
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                fullScreenHelper = new FullScreenHelper(ItemDetailsChordsActivity.this);
...
//                youTubePlayerView.exitFullScreen();
        ...
        ivPlayPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isPlaying) {
                    ivPlayPause.setImageDrawable(ContextCompat.getDrawable(ItemDetailsChordsActivity.this, R.drawable.ic_play));
                    stopAutoScrollPage();

                } else {
                    ivPlayPause.setImageDrawable(ContextCompat.getDrawable(ItemDetailsChordsActivity.this, R.drawable.ic_pause));
...
//    }
    ...
    private void initializeChordDictionary() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ChordDictionary.initialize(ItemDetailsChordsActivity.this);
                return null;
            }
        }.execute((Void) null);
    ...
    private void showConfirmChordchartDialog() {
        ...
        new AlertDialog.Builder(ItemDetailsChordsActivity.this)
