...
public class DBSongDetails extends CreateDB {
    ...
    public boolean insertData(int songId, String songTitle, String songSubtitle, String songLyrics,
                              String songArtist, String songYouTubeURL, Boolean isFavorites) {
