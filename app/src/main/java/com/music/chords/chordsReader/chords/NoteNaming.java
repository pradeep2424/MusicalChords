package com.music.chords.chordsReader.chords;

import com.music.chords.R;
import com.music.chords.chordsReader.utils.EnumMultiMapBuilder;
...
public enum NoteNaming {
    ...
    English(R.string.pref_note_naming_english,
            new EnumMultiMapBuilder<ChordRoot, String>(ChordRoot.class)
                    .put(ChordRoot.A, "A")
                    .put(ChordRoot.Bb, "A#", "Asharp", "Bflat")
                    .put(ChordRoot.B, "B")
                    .put(ChordRoot.C, "C")
                    .put(ChordRoot.Db, "C#", "Dflat", "Csharp")
                    .put(ChordRoot.D, "D")
                    .put(ChordRoot.Eb, "D#", "Eflat", "Dsharp")
                    .put(ChordRoot.E, "E")
                    .put(ChordRoot.F, "F")
                    .put(ChordRoot.Gb, "F#", "Gflat", "Gsharp")
                    .put(ChordRoot.G, "G")
                    .put(ChordRoot.Ab, "G#", "Aflat", "Gsharp")
                    .build()),
//			.put(ChordRoot.A , "A")
